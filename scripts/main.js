...
class Prato {
  constructor(nome, imagem, descricao, preco){
    ...
    this.preco = preco;
    this.elemento = this.getPratoView();
    this.draw();
  }
...
class Bebida {
  constructor(nome, imagem, descricao, preco){
    ...
    this.descricao = descricao;
    this.preco = preco;
    this.elemento = this.getBebidaView();
    this.draw();
  }
...
class Sobremesa {
  constructor(nome, imagem, descricao, preco){
    ...
    this.descricao = descricao;
    this.preco = preco;
    this.elemento = this.getSobremesaView();
    this.draw();
  }
...
for(let prato of pratos){
  new Prato(prato.nome, prato.imagem, prato.descricao, prato.preco);
}

for(let bebida of bebidas){
  new Bebida(bebida.nome, bebida.imagem, bebida.descricao, bebida.preco);
}

for(let sobremesa of sobremesas){
  new Sobremesa(sobremesa.nome, sobremesa.imagem, sobremesa.descricao, sobremesa.preco);
}
